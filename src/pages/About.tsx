  ...
  const capabilities = [
    {
      ...
      description:
        "We design and deliver AI systems that are ready for day-to-day operations, not one-off demos. From document extraction to workflow automation, every solution is built for dependable use.",
    },
    {
      title: "Dependable data and reporting",
      description:
        "We build data pipelines and analytics layers that improve reporting confidence and decision quality. This includes data modelling, anomaly detection, and forecasting aligned to operational planning.",
    },
    {
      title: "Low-lift delivery for busy teams",
      description:
        "We handle scoping, implementation, and rollout with clear communication and manageable milestones. Your team gets tools they can adopt quickly without carrying the technical build workload.",
    },
  ];
    ...
    <section className="mx-auto w-full max-w-6xl space-y-8">
      <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-900/10 sm:p-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-slate-900 sm:text-4xl">
          A practical partner for busy small and medium businesses
        </h1>
        <p className="mt-4 max-w-4xl text-base leading-relaxed text-slate-700">
          ...
          or internal specialist expertise, we provide end-to-end delivery that
          reduces manual work, improves decisions, and supports growth.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-slate-900 px-8 py-10 text-left text-white">
        <h2 className="text-2xl font-semibold">
          Built for outcomes, not experimentation
        </h2>
        <p className="mt-3 max-w-4xl text-sm leading-relaxed text-slate-200 sm:text-base">
          ...
          adoption so your team gets value quickly.
        </p>
        <p className="mt-3 max-w-4xl text-sm leading-relaxed text-slate-200 sm:text-base">
          Whether you need process automation, stronger reporting foundations,
          or a tailored internal platform, we deliver solutions aligned to how
